...
Sometimes the best way to learn is to jump right in and read the code from another module. The [ORM](https://github.com/koseven/orm/blob/3.2/develop/classes/koseven/auth/orm.php) module comes with an auth driver you can learn from.

...
We name our new controller as `Controller_Crop` and accessible through `/crop` URL. Assuming that your project is located at [http://localhost/ko7](http://localhost/ko7), then our crop controller is at [http://localhost/ko7/crop](http://localhost/ko7/crop).

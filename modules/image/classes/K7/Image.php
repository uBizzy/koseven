...
abstract class K7_Image {
	...
	public static function factory($file, $driver = NULL)
	{
		if ($driver === NULL)
		{
			...
			$configured_driver = K7::$config->load('image.default_driver');
	...
	public function __construct($file)
	{
		...
		{
			throw new K7_Exception('Not an image or invalid image: :file',
	...
	public function save($file = NULL, $quality = 100)
	{
		...
		if (is_file($file))
		{
			if ( ! is_writable($file))
			{
				throw new K7_Exception('File must be writable: :file',
					[':file' => Debug::path($file)]);
			}
		}
		else
		{
			...
			{
				throw new K7_Exception('Directory must be writable: :directory',

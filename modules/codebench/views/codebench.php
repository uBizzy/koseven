...
<head>
	...
	<script>
		$(document).ready(function() {
			...
			<?php if (K7::$config->load('codebench')->expand_all) { ?>
...
<body>
	...
	<p id="footer">
		Page executed in <strong><?php echo round(microtime(TRUE) - K7_START_TIME, 2) ?>&nbsp;s</strong>
		using <strong><?php echo Text::widont(Text::bytes(memory_get_usage(), 'MB')) ?></strong> of memory.<br />
		<a href="http://github.com/kohana/codebench">Codebench</a>, a <a href="http://koseven.ga/">K7</a> module

...
Codebench is included in K7 3, but if you need you [can download it](http://github.com/koseven/koseven/codebench/) from GitHub. Be sure Codebench is activated in your `application/bootstrap.php`.

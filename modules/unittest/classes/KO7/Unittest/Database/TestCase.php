 ...
 */
abstract class KO7_Unittest_Database_TestCase extends TestCase{
	...
	/**
	 * The ko7 database connection that PHPUnit should use for this test
	 * @var string
	 */
	...
	{
		$this->_helpers = new KO7_Unittest_Helpers;
	...
	public function getConnection()
	{
		...
		$config = KO7::$config->load('database.'.$this->_database_connection);
     ...
     *
     * @return KO7_Database The database connection
     */
    public function getKO7Connection()
    {
        return Database::instance(KO7::$config->load('unittest')->db_connection);
    }
	...
	{
		return KO7_Unittest_Helpers::clean_cache_dir();
	}
	...
	{
		return KO7_Unittest_Helpers::dir_separator($path);
	}
	...
	{
		return KO7_Unittest_Helpers::has_internet();
	}

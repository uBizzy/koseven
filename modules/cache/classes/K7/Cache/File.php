<?php
/**
 * [K7 Cache](api/K7_Cache) File driver. Provides a file based
 * driver for the K7 Cache library. This is one of the slowest
 * caching methods.
 *
 ...
 *                  'cache_dir'     => APPPATH.'cache/.k7_cache', // Cache location
 *           ),
 *     )
 *
 ...
 */
class K7_Cache_File extends Cache implements Cache_GarbageCollect {
	...
	protected function _check_cache_dir()
	{
		try
		{
			$directory = Arr::get($this->_config, 'cache_dir', K7::$cache_dir);

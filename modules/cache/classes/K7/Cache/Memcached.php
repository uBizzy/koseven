 ...
 */
class K7_Cache_Memcached extends Cache
{
    ...
    protected function __construct(array $config)
    {
        if (!extension_loaded('memcached'))
        {
            ...
            throw new K7_Cache_Exception('memcached extension is not loaded');
        }
        ...
        if (empty($servers))
        {
            ...
            throw new K7_Cache_Exception('no Memcached servers in config/cache.php');
        }
        ...
        foreach ($options as $option => $value)
        {
                    ...
                    && !Memcached::HAVE_IGBINARY)
            {
                ...
                throw new K7_Cache_Exception('serializer Igbinary not supported, please fix config/cache.php');
            }
                    ...
                    && !Memcached::HAVE_JSON)
            {
                ...
                throw new K7_Cache_Exception('serializer JSON not supported, please fix config/cache.php');
            }
        ...
        foreach ($servers as $pos => $server)
        {
            ...
            else
            {
                ...
                throw new K7_Cache_Exception('no host defined for server[' .$pos . '] in config/cache.php');
            }
        }
    }

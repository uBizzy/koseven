...
class K7_HTTP_Cache {
	 ...
	 *
	 * @param   K7_Cache  $cache    engine to use for caching
	 * @return  K7_Cache
	 * @return  K7_Request_Client
	 */
	...
	public function cache_key_callback($callback = NULL)
	{
		...
		if ( ! is_callable($callback))
			throw new K7_Exception('cache_key_callback must be callable!');
	 ...
	 * [K7_Response] returned by [Request::execute].
	 *

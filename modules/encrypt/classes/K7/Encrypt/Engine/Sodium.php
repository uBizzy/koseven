 ...
 */
class K7_Encrypt_Engine_Sodium extends K7_Encrypt_Engine {
	...
	public function __construct($config)
	{
		if (!extension_loaded('sodium')) {
			...
			throw new K7_Exception('Sodium extension is not available');
		...
		if ($this->_cipher === Encrypt_Engine_Sodium::AES_256_GCM && !sodium_crypto_aead_aes256gcm_is_available()) {
			// @codeCoverageIgnoreStart
			throw new K7_Exception('AES-256-GCM is not available on your hardware.');
			// @codeCoverageIgnoreEnd
		}

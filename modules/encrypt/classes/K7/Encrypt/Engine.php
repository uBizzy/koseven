 ...
 */
abstract class K7_Encrypt_Engine {
	...
	public function create_iv(): string
	{
		...
		throw new K7_Exception('Could not create initialization vector.');
	...
	protected function valid_key_length($expected)
	{
		...
		if ($length !== $expected) {
			throw new K7_Exception('No valid encryption key is defined in the encryption configuration: length should be :required_length for :cipher, is: :current_length', [
				':cipher' => $this->_cipher,

<?php
/**
 * Custom Markdown parser for K7 documentation.
 *
 ...
 */
class K7_Kodoc_Markdown extends MarkdownExtra_Parser {
	...
	public function __construct()
	{
		...
		// Parse K7 view inclusions at the very end

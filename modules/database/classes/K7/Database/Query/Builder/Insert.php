 ...
 */
class K7_Database_Query_Builder_Insert extends Database_Query_Builder {
	...
	{
		if ( ! is_string($table))
			throw new K7_Exception('INSERT INTO syntax does not allow table aliasing');
	...
	public function values(array $values)
	{
		...
		{
			throw new K7_Exception('INSERT INTO ... SELECT statements cannot be combined with INSERT INTO ... VALUES');
		}
	...
	public function select(Database_Query $query)
	{
		...
		{
			throw new K7_Exception('Only SELECT queries can be combined with INSERT queries');
		}

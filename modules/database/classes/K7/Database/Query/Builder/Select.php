 ...
 */
class K7_Database_Query_Builder_Select extends Database_Query_Builder_Where {
	...
	public function union($select, $all = TRUE)
	{
		...
		if ( ! $select instanceof Database_Query_Builder_Select)
			throw new K7_Exception('first parameter must be a string or an instance of Database_Query_Builder_Select');

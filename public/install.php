...
<body>
    <div class="container">
        ...
        <p>
            The following tests have been run to determine if Koseven will work in your environment. If any of the tests have failed, consult the <a href="https://docs.koseven.ga/guide/k7/install" target="_blank">documentation</a> for more information on how to correct the problem.
        </p>
        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <?php if (is_dir(SYSPATH) AND is_file(SYSPATH.'classes/K7'.EXT)): ?>
                    <td class="pass">
                        <?php echo SYSPATH ?>
                    </td>
                    <?php else: $failed = TRUE ?>

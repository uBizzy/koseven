...
class K7_View {
	 ...
	 *
	 * @param   string  $k7_view_filename   filename
	 * @param   array   $k7_view_data       variables
	 * @return  string
	 * @throws  Exception
	 */
	protected static function capture($k7_view_filename, array $k7_view_data)
	{
		// Import the view variables to local namespace
		extract($k7_view_data, EXTR_SKIP);
	...
	public function & __get($key)
	{
		...
		{
			throw new K7_Exception('View variable is not set: :var',
				[':var' => $key]);
		}
	}
	...
	{
		if (($path = K7::find_file('views', $file)) === FALSE)
		{

 ...
 *
 * [!!] This file is licensed differently from the rest of K7. As a port of
...
class K7_UTF8 {
	 ...
	 * @param   string  $charset    character set, defaults to K7::$charset
	 * @return  mixed
	 * @uses    UTF8::clean
	...
	public static function transliterate_to_ascii($str, $case = 0)
	{
		...
		{
			require K7::find_file('utf8', __FUNCTION__);
	...
	{
		if (UTF8::$server_utf8)
			return mb_strlen($str, K7::$charset);
	...
	{
		if (UTF8::$server_utf8)
			return mb_strpos($str, $search, $offset, K7::$charset);
	...
	{
		if (UTF8::$server_utf8)
			return mb_strrpos($str, $search, $offset, K7::$charset);
	...
	public static function substr($str, $offset, $length = NULL)
	{
		if (UTF8::$server_utf8)
			return ($length === NULL)
				? mb_substr($str, $offset, mb_strlen($str), K7::$charset)
				: mb_substr($str, $offset, $length, K7::$charset);
	...
	{
		if (UTF8::$server_utf8)
			return mb_strtolower($str, K7::$charset);
	...
	{
		if (UTF8::$server_utf8)
			return mb_strtoupper($str, K7::$charset);
...
if (K7_UTF8::$server_utf8 === NULL)
{
	// Determine if this server supports UTF-8 natively
	K7_UTF8::$server_utf8 = extension_loaded('mbstring');
}

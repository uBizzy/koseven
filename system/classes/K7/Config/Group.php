 ...
 *
 * This is the object returned from K7_Config::load
 *
 ...
 */
class K7_Config_Group extends ArrayObject {
	...
	/**
	 * Constructs the group object.  K7_Config passes the config group
	 * and its config items to the object here.
	 *
	 * @param K7_Config  $instance "Owning" instance of K7_Config
	 * @param string         $group    The group name
	 * @param array          $config   Group's config
	 */
	public function __construct(K7_Config $instance, $group, array $config = [])
	{

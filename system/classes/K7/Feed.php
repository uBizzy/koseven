...
class K7_Feed {
	...
	public static function parse($feed, $limit = 0)
	{
		...
		if ( ! function_exists('simplexml_load_file'))
			throw new K7_Exception('SimpleXML must be installed!');
	...
	{
		$info += ['title' => 'Generated Feed', 'link' => '', 'generator' => 'K7PHP'];
		...
		foreach ($info as $name => $value)
		{
			if ($name === 'image')
			{
				...
				{
					throw new K7_Exception('Feed images require a link, url, and title');
				}

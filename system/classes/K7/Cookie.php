...
class K7_Cookie {
	 ...
	 * @param   string $value value of cookie
	 *
	 * @throws K7_Exception if Cookie::$salt is not configured
	 * @return  string
	 */
	public static function salt($name, $value)
	{
		...
		if ( ! Cookie::$salt)
		{
			throw new K7_Exception('A valid cookie salt is required. Please set Cookie::$salt in your bootstrap.php. For more information check the documentation');
		}

...
class K7_HTTP_Exception_401 extends HTTP_Exception_Expected {
	...
	public function check()
	{
		if ($this->headers('www-authenticate') === NULL)
			throw new K7_Exception('A \'www-authenticate\' header must be specified for a HTTP 401 Unauthorized');

...
class K7_Inflector {
	 ...
	 * case, please report [an issue](http://koseven.ga/projects/K7/issues).
	 *
	...
	public static function uncountable($str)
	{
		...
		{
			// Cache uncountables
			Inflector::$uncountable = K7::$config->load('inflector')->uncountable;
	...
	public static function singular($str, $count = NULL)
	{
		...
		if (empty(Inflector::$irregular))
		{
			...
			Inflector::$irregular = K7::$config->load('inflector')->irregular;
		}

...
class K7_Profiler {
	...
	public static function application()
	{
		...
		$stats = K7::cache('profiler_application_stats', NULL, 3600 * 24);
		...
		$time = microtime(TRUE) - K7_START_TIME;

		// Get the total memory usage
		$memory = memory_get_usage() - K7_START_MEMORY;
		...
		// Cache the new stats
		K7::cache('profiler_application_stats', $stats);

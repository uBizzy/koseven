...
/**
 * Tests the Validation lib that's shipped with K7
 *
 * @group k7
 * @group k7.core
 * @group k7.core.validation
 *
 * @package    K7
 * @category   Tests
 * @author     Kohana Team
 ...
 */
class K7_ValidationTest extends Unittest_TestCase
{
	/**

 ...
 */
class K7_HTMLTest extends Unittest_TestCase {
	...
	{
		parent::setUp();
		K7::$config->load('url')->set('trusted_hosts', ['www\.koseven\.ga']);
	}
	...
	public function provider_script()
	{
		return [
			...
			[
				'<script type="text/javascript" src="http://www.koseven.ga/k7/index.php/my/script.js"></script>',
				'my/script.js',
				NULL,
				'http',
				TRUE
			...
			[
				'<script type="text/javascript" src="https://www.koseven.ga/k7/my/script.js"></script>',
				'my/script.js',
				NULL,
				'https',
				FALSE
	...
	public function provider_style()
	{
		return [
			...
			[
				'<link type="text/css" href="/k7/my/style.css" rel="stylesheet" />',
				'my/style.css',
				[],
				NULL,
				FALSE
			...
			[
				'<link type="text/css" href="https://www.koseven.ga/k7/my/style.css" rel="stylesheet" />',
				'my/style.css',
				[],
				'https',
				FALSE
			...
			[
				'<link type="text/css" href="https://www.koseven.ga/k7/index.php/my/style.css" rel="stylesheet" />',
				'my/style.css',
				[],
				'https',
				TRUE
			...
			[
				...
				'<link type="text/css" href="https://www.koseven.ga/k7/index.php/my/style.css" rel="stylesheet/less" />',
				'my/style.css',
				[
					'rel' => 'stylesheet/less'
				],
	...
	public function provider_anchor()
	{
		return [
			...
			[
				'<a href="https://www.koseven.ga/k7/users/example">K7</a>',
				[],
				'users/example',
				'K7',
				NULL,
			...
			[
				'<a href="https://www.koseven.ga/k7/index.php/users/example">K7</a>',
				[],
				'users/example',
				'K7',
				NULL,
	...
	public function provider_file_anchor()
	{
		return [
			[
				'<a href="/k7/mypic.png">My picture file</a>',
				[],
				'mypic.png',
				'My picture file',
			],
			[
				'<a href="https://www.koseven.ga/k7/index.php/mypic.png" attr="value">My picture file</a>',
				['attr' => 'value'],
				'mypic.png',
				'My picture file',
				'https',
			...
			[
				'<a href="ftp://www.koseven.ga/k7/mypic.png">My picture file</a>',
				[],
				'mypic.png',
				'My picture file',
				'ftp',
	...
	public function provider_image()
	{
		return [
			...
			[
				'<img src="/k7/img/image.png" />',
				'img/image.png',
			],
			[
				'<img src="https://www.koseven.ga/k7/index.php/img/image.png" alt="..." />',
				'img/image.png',
				['alt' => '...',],
				'https',
				TRUE

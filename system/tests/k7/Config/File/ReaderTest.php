...
/**
 * Tests the Config file reader that's shipped with k7
 *
 * @group k7
 * @group k7.config
 *
 ...
 */
class K7_Config_File_ReaderTest extends K7_Unittest_TestCase {
	 ...
	 *
	 * @test
	 * @covers K7_Config_File_Reader
	 */
	public function test_default_search_dir_is_config()
	{
		$reader = new K7_Config_File_Reader;
	...
	{
		$reader = new K7_Config_File_Reader('gafloog');
	 ...
	 *
	 * @test
	 * @covers K7_Config_File_Reader::load
	 */
	public function test_load_returns_empty_array_if_conf_dir_dnx()
	{
		$config = new K7_Config_File_Reader('gafloogle');
	...
	{
		$config = new K7_Config_File_Reader;

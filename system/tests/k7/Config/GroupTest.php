 ...
 */
class K7_Config_GroupTest extends TestCase
{
	/**
	 * Create a mock K7_Config instance
	 *
	 * @return K7_Config
	 */
	public function get_mock_config()
	{
		return new K7_Config;
	}

	/**
	 * Gets a fresh instance of K7_Config_Group
	 *
	 * @param string        $group    Config Group name
	 * @param array         $config   Configuration
	 * @param K7_Config $instance Instance of K7_Config
	 * @return K7_Config_Group
	 */
	public function get_mock_group($group, $config = [], $instance = NULL)
	{
		...
		return new K7_Config_Group($instance, $group, $config);
	}
	...
	public function test_loads_group_name_and_values_in_constructor()
	{
		...
		// by casting the object in question into an array.  This usually works fine, but as K7_Config_Group
	 ...
	 *
	 * @test
	 * @covers K7_Config_Group::get
	 */
	public function test_get_fetches_config_value()
	{
		$group = $this->get_mock_group('k7', ['status' => 'awesome']);
	 ...
	 *
	 * @test
	 * @covers K7_Config_Group::set
	 */
	public function test_set_modifies_existing_config()
	{
		$group = $this->get_mock_group('k7', ['status' => 'pre-awesome']);
	 ...
	 *
	 * @test
	 * @covers K7_Config_Group::offsetSet
	 */
	public function test_writes_changes_to_config()
	{
		$mock  = $this->createMock('K7_Config', ['_write_config']);

		$mock
			->expects($this->exactly(3))
			->method('_write_config')
			->with('k7', 'status', $this->LogicalOr('totally', 'maybe', 'not'));

		$group = $this->get_mock_group('k7', ['status' => 'kool'], $mock);
	 ...
	 *
	 * @test
	 * @covers K7_Config_Group::as_array
	 */
	 ...
	 *
	 * @test
	 * @covers K7_Config_Group::__toString
	 */
	public function test_to_string_serializes_array_output()
	{
		$vars   = ['k7' => 'cool', 'unit_tests' => 'boring'];

 ...
 */
class K7_HTTPTest extends Unittest_TestCase {
	...
	{
		parent::setUp();
		K7::$config->load('url')->set('trusted_hosts', ['www\.example\.com']);
	...
	public function provider_redirect()
	{
		return [
			...
			[
				...
				302,
				'HTTP_Exception_302',
				'http://www.example.com/k7/index.php/page_one'
			],
			[
				'page_two',
				303,
				'HTTP_Exception_303',
				'http://www.example.com/k7/index.php/page_two'
			],
		];
	}

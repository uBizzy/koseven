...
/**
 * Tests K7 upload class
 *
 * @group k7
 * @group k7.core
 * @group k7.core.upload
 *
 * @package    K7
 * @category   Tests
 * @author     Kohana Team
 ...
 */
class K7_UploadTest extends Unittest_TestCase
{
	/**
			...
			[
				...
				['_FILES' => [
					'unit_test' => [
						...
						'name' => 'Unit_Test File',
						'type' => 'image/png',
						'tmp_name' => K7::find_file('tests', 'test_data/github', 'png'),
						'size' => filesize(K7::find_file('tests', 'test_data/github', 'png')),
						]
					]
				],
				TRUE

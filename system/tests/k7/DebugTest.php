 ...
 */
class K7_DebugTest extends Unittest_TestCase
{
	...
	public function provider_debug_path()
	{
		return [
			[
				SYSPATH.'classes'.DIRECTORY_SEPARATOR.'k7'.EXT,
				'SYSPATH'.DIRECTORY_SEPARATOR.'classes'.DIRECTORY_SEPARATOR.'k7.php'
			],
			[
				MODPATH.$this->dirSeparator('unittest/classes/k7/unittest/runner').EXT,
				$this->dirSeparator('MODPATH/unittest/classes/k7/unittest/runner').EXT
			],
		];
	}

 ...
 * @group k7.request.client.external
 *
 * @package    K7
 * @category   Tests
 * @author     Kohana Team
 ...
 */
class K7_Request_Client_ExternalTest extends Unittest_TestCase {
	...
	public function provider_execute()
	{
		...
		return [
			...
			[
				...
				$post,
				[
					'content-type' => 'application/x-www-form-urlencoded; charset='.K7::$charset,

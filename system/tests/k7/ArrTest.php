...
/**
 * Tests the Arr lib that's shipped with k7
 *
 * @group k7
 * @group k7.core
 * @group k7.core.arr
 ...
 */
class K7_ArrTest extends Unittest_TestCase
{
	/**
	...
	public function provider_extract()
	{
		return [
			[
				['k7' => 'awesome', 'blueflame' => 'was'],
				['k7', 'cakephp', 'symfony'],
				NULL,
				['k7' => 'awesome', 'cakephp' => NULL, 'symfony' => NULL]
			],
	...
	public function provider_path()
	{
		...
		return [
			...
			[NULL, $array, 'k7.alternatives',  NULL],
			// Try using a string as a default
			['nothing', $array, 'k7.alternatives',  'nothing'],
	...
	public function provider_set_path()
	{
		return [
			// Tests returns normal values
			[['foo' => 'bar'], [], 'foo', 'bar'],
			[['k7' => ['is' => 'awesome']], [], 'k7.is', 'awesome'],
			[['k7' => ['is' => 'cool', 'and' => 'slow']],
				  ['k7' => ['is' => 'cool']], 'k7.and', 'slow'],
			// Custom delimiters
			[['k7' => ['is' => 'awesome']], [], 'k7/is', 'awesome', '/'],

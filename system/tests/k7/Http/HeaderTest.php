<?php
/**
 * Unit Tests for K7_HTTP_Header
 *
 * @group k7
 * @group k7.core
 * @group k7.core.http
 * @group k7.core.http.header
 * @group k7.core.http.header
 *
 * @package    K7
 * @category   Tests
 ...
 */
class K7_HTTP_HeaderTest extends Unittest_TestCase {
	...
	{
		$content_type = K7::$content_type.'; charset='.K7::$charset;

 ...
 */
class K7_URLTest extends Unittest_TestCase
{
	...
	public function provider_base()
	{
		return [
			...
			[NULL,    FALSE, NULL,  NULL, ['K7::$base_url' => NULL]],
			[NULL,    FALSE, NULL,  '/', ['K7::$base_url' => '/']],
			[NULL,    FALSE, NULL,  '/k7/'],
			['http',  FALSE, NULL,  'http://example.com/k7/'],
			['http',  FALSE, 'sub', 'http://sub.example.com/k7/'],
			['http',  FALSE, 'sub', 'http://sub.example.com/k7/', ['HTTP_HOST' => 'sub.example.com']],
			['http',  FALSE, 'sub', 'http://sub.example.com/k7/', ['HTTP_HOST' => 'invalid.example.com']],
			[NULL,    TRUE,  NULL,  '/k7/index.php/'],
			['http',  TRUE,  NULL,  'http://example.com/k7/index.php/'],
			['http',  TRUE,  'sub', 'http://sub.example.com/k7/index.php/'],
			['https', TRUE,  NULL,  'https://example.com/k7/index.php/'],
			['https', TRUE,  'sub', 'https://sub.example.com/k7/index.php/'],
			['ftp',   TRUE,  NULL,  'ftp://example.com/k7/index.php/'],
			['ftp',   TRUE,  'sub', 'ftp://sub.example.com/k7/index.php/'],

			// Test for automatic protocol detection, protocol = TRUE
			[TRUE, TRUE, NULL, 'cli://example.com/k7/index.php/', ['HTTPS' => FALSE, 'Request::$initial' => Request::factory('/')->protocol('cli')]],

			// Change base url'
			['https', FALSE, NULL, 'https://example.com/k7/', ['K7::$base_url' => 'omglol://example.com/k7/']],

			// Use port in base url, issue #3307
			['http', FALSE, NULL, 'http://example.com:8080/', ['K7::$base_url' => 'example.com:8080/']],

			// Use protocol from base url if none specified
			[NULL, FALSE, NULL, 'http://www.example.com/', ['K7::$base_url' => 'http://www.example.com/']],

			[NULL, FALSE, 'sub', 'http://sub.example.com/', ['K7::$base_url' => 'http://www.example.com/']],

			// Use HTTP_HOST before SERVER_NAME
			['http', FALSE, NULL, 'http://example.com/k7/', ['HTTP_HOST' => 'example.com', 'SERVER_NAME' => 'example.org']],

			// Use SERVER_NAME if HTTP_HOST DNX
			['http', FALSE, NULL, 'http://example.org/k7/', ['HTTP_HOST' => NULL, 'SERVER_NAME' => 'example.org']],
		];
	}
	 ...
	 * @param array   $enviroment  Array of enviroment vars to change @see K7_URLTest::setEnvironment()
	 */
	...
	public function provider_site()
	{
		return [
			['', NULL,		'/k7/index.php/'],
			['', 'http',			'http://example.com/k7/index.php/'],

			['my/site', NULL, '/k7/index.php/my/site'],
			['my/site', 'http',  'http://example.com/k7/index.php/my/site'],

			// @ticket #3110
			['my/site/page:5', NULL, '/k7/index.php/my/site/page:5'],
			['my/site/page:5', 'http', 'http://example.com/k7/index.php/my/site/page:5'],

			['my/site?var=asd&k7=awesome', NULL,  '/k7/index.php/my/site?var=asd&k7=awesome'],
			['my/site?var=asd&k7=awesome', 'http',  'http://example.com/k7/index.php/my/site?var=asd&k7=awesome'],

			['?k7=awesome&life=good', NULL, '/k7/index.php/?k7=awesome&life=good'],
			['?k7=awesome&life=good', 'http', 'http://example.com/k7/index.php/?k7=awesome&life=good'],

			['?k7=awesome&life=good#fact', NULL, '/k7/index.php/?k7=awesome&life=good#fact'],
			['?k7=awesome&life=good#fact', 'http', 'http://example.com/k7/index.php/?k7=awesome&life=good#fact'],

			['some/long/route/goes/here?k7=awesome&life=good#fact', NULL, '/k7/index.php/some/long/route/goes/here?k7=awesome&life=good#fact'],
			['some/long/route/goes/here?k7=awesome&life=good#fact', 'http', 'http://example.com/k7/index.php/some/long/route/goes/here?k7=awesome&life=good#fact'],

			['/route/goes/here?k7=awesome&life=good#fact', 'https', 'https://example.com/k7/index.php/route/goes/here?k7=awesome&life=good#fact'],
			['/route/goes/here?k7=awesome&life=good#fact', 'ftp', 'ftp://example.com/k7/index.php/route/goes/here?k7=awesome&life=good#fact'],
		];
	}
	...
	public function provider_site_url_encode_uri()
	{
		...
		foreach ($provider as $i => $params)
		{
			...
			$provider[$i] = ["/k7/index.php/{$expected}", $uri];
		}

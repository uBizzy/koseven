...
/**
 * Tests the k7 text class (K7_Text)
 *
 * @group k7
 * @group k7.core
 * @group k7.core.text
 ...
 * @category   Tests
 */
class K7_TextTest extends Unittest_TestCase
{
	...
	function provider_censor()
	{
		...
		return [
				...
				["Cake### isn't nearly as good as k7###", "CakePHP isn't nearly as good as k7php", ['php'], '#', TRUE],
	...
	function provider_widont()
	{
		return [
			 ...
			 * array(
			 * 		'with HTML at the end &nbsp;<strong>K7</strong>',
			 * 		'with HTML at the end <strong>K7</strong>',
			 * 	),
			 * 	// @issue 3499, with HTML with attributes at the end
			 * 	array(
			 * 		'with HTML at the end:&nbsp;<a href="#" title="K7">K7</a>',
			 * 		'with HTML at the end: <a href="#" title="K7">K7</a>',
			 * 	),
			 */
				[

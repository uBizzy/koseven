...
include K7::find_file('tests', 'test_data/callback_routes');

class K7_RouteTest extends Unittest_TestCase
{
	/**
	 * Remove all caches
	...
	// @codingStandardsIgnoreEnd
	{
		...
		K7::$config->load('url')->set('trusted_hosts', ['koseven\.ga']);

        /**
         * If Unit-Testing a cache driver "K7_Cache" is indeed available
	 ...
	 * it should throw a K7_Exception
	 *
	...
	public function test_uri_throws_exception_if_required_params_are_missing($uri, $regex, $uri_array)
	{
        ...
        $this->expectException('K7_Exception');
		$route->uri($uri_array);
	}

...
2. Once we are in `bootstrap.php`:
	6. The [KO7] class is loaded.
	7. [KO7::init] is called, which sets up error handling, caching, and logging.
	8. [KO7_Config] readers and [KO7_Log] writers are attached.
	9. [KO7::modules] is called to enable additional modules.

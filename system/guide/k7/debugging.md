...
K7 includes several tools to help you debug your application.
...
K7 also provides a method to show the source code of a particular file using [Debug::source].
...
If you are having trouble getting something to work correctly, you could check your K7 logs and your webserver logs, as well as using a debugging tool like [Xdebug](http://www.xdebug.org/).

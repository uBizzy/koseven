...
2. Once we are in `bootstrap.php`:
	6. The [K7] class is loaded.
	7. [K7::init] is called, which sets up error handling, caching, and logging.
	8. [K7_Config] readers and [K7_Log] writers are attached.
	9. [K7::modules] is called to enable additional modules.

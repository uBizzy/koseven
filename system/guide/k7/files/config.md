...
We could now call `K7::$config->load('site.title')` to get the site name, and `K7::$config->load('site.analytics')` to get the analytics code.
...
You could then do the following:
	...
	// In your controller
	$view->versions = K7::$config->load('versions');
